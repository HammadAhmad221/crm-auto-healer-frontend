...
const QuoteDetails = () => {
  ...
  return (
    <div className="max-w-3xl mx-auto p-8 bg-white shadow-lg rounded-lg">
      ...
      <div className="mb-4">
        <h3 className="text-lg font-medium text-gray-700">Distance:</h3>
        <p>{quote.distance}</p>
      </div>
      <div className="mb-4">
        <h3 className="text-lg font-medium text-gray-700">Vehicle Type:</h3>
        <p>{quote.vehicleType}</p>
      </div>
      {/* <div className="mb-4">
        <h3 className="text-lg font-medium text-gray-700">Factors:</h3>
        <p>{quote.factors}</p>
      </div> */}
      <div className="mb-4">
        <h3 className="text-lg font-medium text-gray-700">Status:</h3>
